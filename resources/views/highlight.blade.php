                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    @empty
                        ...
                        <div class="match-card rounded-2xl overflow-hidden flex flex-col justify-between group">
                            <div>
                                <div class="relative aspect-video w-full bg-[#091413] overflow-hidden">
                                    <iframe class="w-full h-full border-0" src="https://www.youtube-nocookie.com/embed/n7w0eI7e1B8?rel=0"
                                ...
                                <div class="p-5 space-y-3">
                                    <div class="flex items-center justify-between text-xs">
                                        <span class="font-bold text-[#408A71] bg-[#285A48]/30 px-2 py-0.5 rounded border border-[#285A48] truncate max-w-[180px]">
                                            🏴󠁧󠁢󠁥󠁮󠁧󠁿 Premier League
                                        </span>
                                        <span class="text-slate-400 font-mono text-[11px] bg-[#091413] px-2 py-0.5 rounded border border-[#285A48] shrink-0">
                                            ⏱️ Pekan ke-5
                                        </span>
                                    </div>
                                    <div class="flex items-center gap-2 text-xs font-medium text-slate-300 py-1 border-b border-[#285A48]/50">
                                        <img src="https://crests.football-data.org/57.png" class="w-4 h-4 object-contain shrink-0" alt="Arsenal" />
                                        <span class="text-white font-semibold truncate">Arsenal</span>
                                        <span class="text-[#408A71] font-bold">vs</span>
                                        <img src="https://crests.football-data.org/65.png" class="w-4 h-4 object-contain shrink-0" alt="Man City" />
                                        <span class="text-white font-semibold truncate">Manchester City</span>
                                    </div>
                                    <h3 class="font-bold text-white text-sm sm:text-base group-hover:text-[#408A71] transition-colors line-clamp-2">
                                        Arsenal vs Manchester City: Drama Sengit Menit Akhir di Emirates
                                    </h3>
                                    <p class="text-xs text-slate-400 leading-relaxed line-clamp-2">
                                        Pertarungan intensitas tinggi dengan 28 total tembakan. Cuplikan gol penyeimbang di injury time serta duel taktis Mikel Arteta vs Pep Guardiola.
                                    </p>
                                </div>
                            </div>
                            <div class="px-5 pb-5 pt-2 border-t border-[#285A48]/40">
                        ...
                        <div class="match-card rounded-2xl overflow-hidden flex flex-col justify-between group">
                            <div>
                                <div class="relative aspect-video w-full bg-[#091413] overflow-hidden">
                                    <iframe class="w-full h-full border-0" src="https://www.youtube-nocookie.com/embed/kY3Onr6f6j8?rel=0"
                                ...
                                <div class="p-5 space-y-3">
                                    ...
                                    <div class="flex items-center gap-2 text-xs font-medium text-slate-300 py-1 border-b border-[#285A48]/50">
                                        <img src="https://crests.football-data.org/64.png" class="w-4 h-4 object-contain shrink-0" alt="Liverpool" />
                                        <span class="text-white font-semibold truncate">Liverpool</span>
                                        <span class="text-[#408A71] font-bold">vs</span>
                                        <img src="https://crests.football-data.org/61.png" class="w-4 h-4 object-contain shrink-0" alt="Chelsea" />
                                    ...
                                    <p class="text-xs text-slate-400 leading-relaxed line-clamp-2">
                                        Aksi serangan balik kilat The Reds dan penyelamatan krusial di bawah mistar gawang dalam laga panas Super Sunday.
                                    </p>
                                </div>
                            </div>
                            <div class="px-5 pb-5 pt-2 border-t border-[#285A48]/40">
                        ...
                        <div class="match-card rounded-2xl overflow-hidden flex flex-col justify-between group">
                            <div>
                                <div class="relative aspect-video w-full bg-[#091413] overflow-hidden">
                                    <iframe class="w-full h-full border-0" src="https://www.youtube-nocookie.com/embed/5qap5aO4i9A?rel=0"
                                ...
                                <div class="p-5 space-y-3">
                                    ...
                                    <div class="flex items-center gap-2 text-xs font-medium text-slate-300 py-1 border-b border-[#285A48]/50">
                                        <img src="https://crests.football-data.org/86.png" class="w-4 h-4 object-contain shrink-0" alt="Real Madrid" />
                                        <span class="text-white font-semibold truncate">Real Madrid</span>
                                        <span class="text-[#408A71] font-bold">vs</span>
                                        <img src="https://crests.football-data.org/81.png" class="w-4 h-4 object-contain shrink-0" alt="Barcelona" />
                                    ...
                                    <p class="text-xs text-slate-400 leading-relaxed line-clamp-2">
                                        Rangkuman aksi serangan balik cepat Real Madrid dan dominasi penguasaan bola Barcelona yang menghasilkan duel sengit hingga menit akhir.
                                    </p>
                                </div>
                            </div>
                            <div class="px-5 pb-5 pt-2 border-t border-[#285A48]/40">
